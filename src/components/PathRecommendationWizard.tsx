...
const paths = {
  learn: {
    ...
    description: "Build deep knowledge of fragility signals with guided exploration",
    icon: BookOpen,
    color: "primary",
    link: "/early-access",
  ...
  trade: {
    ...
    description: "Connect your wallet and express views through prediction markets",
    icon: Users,
    color: "secondary",
    link: "/markets",
    cta: "View Markets",
  ...
  inform: {
    id: "inform",
    title: "Stay Informed",
    description: "Receive weekly intelligence reports delivered to your inbox",
    icon: Mail,
    color: "accent",
    link: "/intelligence",
    cta: "Subscribe Now",
